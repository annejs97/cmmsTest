...
Mobile.sendKeys(findTestObject('Object Repository/Login/android.widget.EditText'), '3serangkai@gmail.com')

Mobile.tap(findTestObject('Object Repository/Login/android.widget.Button (1)'), 0)

Mobile.sendKeys(findTestObject('Object Repository/Login/android.widget.EditText (2)'), 'password')
